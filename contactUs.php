...
<p><label class="oneFifty">Telephone:</label>
   <input type="tel" name="tel" placeholder="000-000-0000" />
</p>
<p><label>Preference</label>
   <input type="radio" name="preference" value="emailPref" /> Email <input type="radio" name="preference" value="telPref" /> Telephone</p>
   <br /> 
<p><label>Leave us a message here, please.</label><br />
...
$body  = "<h2>This message was sent from The Nguvu.</h2>\n";
$body .= "<p>Name: $firstName $lastName<br>\n";
$body .= "Email: $email<br>\n";
$body .= "Telephone: $tel<br />\n";
$body .= "Message: $message<br /><br>\n";
if ($preference == "emailPref")
{
   $body .= "$firstName would prefer to be contacted by Email.</p>\n";
}
else
{
   $body .= "$firstName would prefer to be contacted by Telephone.</p>";
} // end IF PREFERENCE 
